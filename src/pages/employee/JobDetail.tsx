...
// // Define types for Job and Company
// interface Company {
//   profileUrl: string;
//   name: string;
//   location: string;
...
// type JobDetailType = {
//  id: number; // Assuming id is a string in your data
//   company: {
//     name: string;
//     location: string;
//     email: string;
...
//     requirement: string;
//   }[];
//   applicants: string[]; // Assuming applicants is an array of strings
//   vacancies: number;
//   createdAt: Date;
// };

// const JobDetail = () => {
//   const params = useParams<{ id: string }>(); // Specify that params.id is a string
//   const id = parseInt(params?.id ?? "0", 10) - 1; // Convert id to number, fallback to 0 if invalid

//   const [job, setJob] = useState<JobDetailType>(jobs[0]);
//   const [selected, setSelected] = useState<string>("0");

//   useEffect(() => {
//     if (!isNaN(id) && id >= 0 && id < jobs.length) {
//       setJob(jobs[id] ?? jobs[0]);  
//     }
