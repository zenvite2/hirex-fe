...
// Định nghĩa kiểu mới cho Company
interface Company {
  _id: number; // Đảm bảo kiểu ở đây là number
  profileUrl?: string;
  name: string;
  email?: string;
  location?: string;
  jobPosts?: Array<any>; // Có thể thay đổi 'any' thành loại cụ thể nếu có
}

interface CompanyCardProps {
  cmp: Company; // Đảm bảo kiểu ở đây khớp
}
