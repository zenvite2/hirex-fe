...
const ForgotPassword: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error('Failed to send the new password. Please try again.');
        } finally {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">Quên mật khẩu</h1>
                <p className="mb-4 text-gray-700 text-center">
                    Vui lòng nhập tên đăng nhập tài khoản của bạn. Mật khẩu mới sẽ được gửi qua email.
                </p>
