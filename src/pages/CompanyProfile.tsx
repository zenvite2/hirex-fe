...
// // Define the types for the props of CompnayForm component
...
//   const { user } = useSelector((state: any) => state.user); // Adjust the state type according to your redux setup
//   const {
//     register,
//     handleSubmit,
//     formState: { errors },
...
//   useEffect(() => {
//     setInfo(companies[parseInt(params.id, 10) - 1] ?? null);
