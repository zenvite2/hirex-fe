...
// Nếu đã đổi tên, hãy sử dụng tên kiểu mới
interface CompanyData {
  _id: string; // Hoặc number, tùy thuộc vào dữ liệu bạn có
  profileUrl?: string;
  name: string;
  email?: string;
  location?: string;
  jobPosts?: Array<any>; // Bạn có thể thay 'any' bằng loại cụ thể nếu có
}

interface CompanyCardProps {
  cmp: CompanyData; // Đổi từ Company thành CompanyData
}
